        ...
        <AppProvider>
          ...
          >
            <div className="scroll-x-lg lg:bg-gray-200 h-screen w-screen flex items-center justify-center p-0 lg:p-[100px]">
              <main className="flex flex-col lg:grid lg:grid-cols-12 h-screen w-screen lg:w-full lg:h-full bg-slate-50 lg:border lg:border-gray-100 max-w-[1240px] lg:rounded-xl">
                <div className="w-full p-4 lg:p-6 col-span-4 flex flex-col pb-6 lg:pr-6 gap-4">
                  <Search />
                  <WeatherOverview />
                </div>

                <div className="p-4 lg:p-6 col-span-8 bg-slate-100 flex flex-col lg:pl-6">
                  {children}
                </div>
              </main>
            </div>
